package com.example.aiadvice.controller;
...
import com.example.aiadvice.service.RecomendationService;
...
public class RecomendationController {
	...
	public ResponseEntity<Recomendation> getRecomendation(@PathVariable("activityId") String activityId){
